...
public class Calculator {
	...
	static void SetPrederterminedInfo()
	{
		...
		RotationVector = Calculator.getRotationVector(J3DScreen.ViewFrom, J3DScreen.ViewTo);
		W1 = ViewVector.CrossProduct(RotationVector);
		W2 = ViewVector.CrossProduct(W1);

		CalcFocusPos = Calculator.CalculatePositionP(J3DScreen.ViewFrom, J3DScreen.ViewTo, J3DScreen.ViewTo[0], J3DScreen.ViewTo[1], J3DScreen.ViewTo[2]);
