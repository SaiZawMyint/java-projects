...
public class Prism {
	...
	public Prism(double x, double y, double z, double width, double length, double height, Color c)
	{
		...
		Polys[1] = new J3DPolygon(new double[]{x, x, x+width, x+width}, new double[]{y, y, y, y},  new double[]{z, z+height, z+height, z}, c, false,true);
		J3DScreen.DPolygons.add(Polys[1]);
		Polys[2] = new J3DPolygon(new double[]{x+width, x+width, x+width}, new double[]{y, y, y+length},  new double[]{z, z+height, z+height}, c, false,true);
		J3DScreen.DPolygons.add(Polys[2]);
		Polys[3] = new J3DPolygon(new double[]{x, x, x+width, x+width}, new double[]{y+length, y+length, y+length, y+length},  new double[]{z, z+height, z+height, z}, c, false,true);
		J3DScreen.DPolygons.add(Polys[3]);
		Polys[4] = new J3DPolygon(new double[]{x, x, x}, new double[]{y, y, y+length},  new double[]{z, z+height, z+height}, c, false,true);
