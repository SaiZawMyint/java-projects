...
public class Pyramid {
	...
	public Pyramid(double x, double y, double z, double width, double length, double height, Color c)
	{
		...
		Polys[1] = new J3DPolygon(new double[]{x, x, x+width}, new double[]{y, y, y, y},  new double[]{z, z+height, z+height}, c, false,true);
		...
		Polys[3] = new J3DPolygon(new double[]{x, x, x+width}, new double[]{y+length, y+length, y+length},  new double[]{z, z+height, z+height}, c, false,true);
